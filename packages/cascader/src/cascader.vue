...
<script>
import Popper from 'element-sea/src/utils/vue-popper';
import Clickoutside from 'element-sea/src/utils/clickoutside';
import Emitter from 'element-sea/src/mixins/emitter';
import Locale from 'element-sea/src/mixins/locale';
import Migrating from 'element-sea/src/mixins/migrating';
import ElInput from 'element-sea/packages/input';
import ElTag from 'element-sea/packages/tag';
import ElScrollbar from 'element-sea/packages/scrollbar';
import ElCascaderPanel from 'element-sea/packages/cascader-panel';
import AriaUtils from 'element-sea/src/utils/aria-utils';
import { t } from 'element-sea/src/locale';
import { isEqual, isEmpty, kebabCase } from 'element-sea/src/utils/util';
import { isUndefined, isFunction } from 'element-sea/src/utils/types';
import { isDef } from 'element-sea/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'element-sea/src/utils/resize-event';
