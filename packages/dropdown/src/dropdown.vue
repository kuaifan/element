<script>
  ...
  import ElButton from 'element-sea/packages/button';
  import ElButtonGroup from 'element-sea/packages/button-group';
  import { generateId } from 'element-sea/src/utils/util';
